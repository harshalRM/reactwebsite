            ...
            <div className="container my-5 py-3">
                <div className="row">
                    <div className="col-md-6 d-flex justify-content-center mx-auto product">
                        <img src={product.img} alt={product.title} height="700px" className='' />
                    </div>
                    <div className="col-md-6 d-flex flex-column justify-content-center">
                        ...
                        <hr />
                        <h2 className="fw-bold my-4 fs-4">Standard Size: <input list="browsers" id="size" className='fw-bold p-2 m-2 w-50'/></h2>
                        ...
                        <h2 className="fw-bold my-4 fs-4">Quantity : <input type="number" id='quantity' className='fw-bold p-2 m-2 w-50' /></h2>
                        <hr />
